...
function showResults() {
  ...
  const phone = localStorage.getItem("quiz_phone") || "03759632 - 03305527";
  document.getElementById("resultUser").textContent = `مدرسة علي عاشورمدرسة خريس لتعليم قيادة السيارات  — ${phone}`;
...
async function init() {
  ...
  document.getElementById("userName").textContent = "مدرسة خريس لتعليم قيادة السيارات";
